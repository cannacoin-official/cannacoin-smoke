...
# Script to automate Cannacoin wallet compilation on Raspberry Pi with Ubuntu Server 22.04
...
echo -e "${GREEN}Starting Cannacoin wallet compilation process on Raspberry Pi...${NC}"
